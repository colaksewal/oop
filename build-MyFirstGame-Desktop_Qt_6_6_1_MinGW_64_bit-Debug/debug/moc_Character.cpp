...
#include "D:/OOP-new/oop/MyFirstGame/Character.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSCharacterENDCLASS_t qt_meta_stringdata_CLASSCharacterENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(10, 17),  // "characterSelected"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 13)   // "characterName"
    },
    "Character",
    "characterSelected",
    "",
...
void Character::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->characterSelected((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Character::*)(const QString & );
            if (_t _q_method = &Character::characterSelected; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Character::characterSelected(const QString & _t1)
{
